...
export default function PropertyCard({ property, index = 0 }: PropertyCardProps) {
  ...
  return (
    <motion.article
      ...
      className="group bg-white rounded-2xl overflow-hidden border border-brand-sand shadow-sm hover:shadow-xl hover:shadow-brand-navy/8 transition-all duration-300 hover:-translate-y-1"
    >
      {/* Image */}
      ...
      {/* Content */}
      <div className="p-6">
        <h3 className="font-serif text-brand-navy text-2xl font-semibold mb-2">
          {name}
        </h3>
