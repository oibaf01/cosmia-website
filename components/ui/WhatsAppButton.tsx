...
export default async function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="whatsapp-btn fixed bottom-6 right-6 z-50 flex items-center justify-center w-12 h-12 rounded-full bg-[#25D366] text-white hover:scale-110 transition-transform duration-200 cursor-pointer"
    >
